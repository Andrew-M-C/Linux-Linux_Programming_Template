...
#define CFG_AMC_DICT_DEFAULT_KEY_LEN	32
...
AMCDictErrno_st AMCDictionary_GlobalConfig(
			ssize_t initDictCount, ssize_t growDictCount, ssize_t initItemCount, ssize_t growItemCount, ssize_t defaultKeyLen);
